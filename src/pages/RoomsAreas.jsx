    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-3 md:p-6" dir="rtl">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-slate-800">ניהול אזורים</h1>
            ...
            {[...areas]
              ...
              .map((area) => (
                <div key={area.id} className="relative group">
                  <AreaCard area={area} />
                  <div className="absolute top-3 left-3 flex gap-1.5 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                    <button
