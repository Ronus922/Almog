    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 overflow-x-hidden" dir="rtl">
        ...
        <div className="w-full space-y-4 md:space-y-6 p-3 md:p-6">
          ...
          {(activeTab==='debtors'||!isAdmin) && <DebtorsTable records={isAdmin ? tabDatasets.debtorsTab : records.filter(r => !r.isArchived)} onRowClick={handleRowClick} isAdmin={isAdmin} settings={settings} allStatuses={allStatuses} onFilteredDataChange={setFilteredDataset} onRecordUpdate={handleRecordUpdate} showArchived={false}/>}
