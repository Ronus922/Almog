...
const HEBREW_HOLIDAYS = [
  // 2025
  { date: '2025-04-13', name: 'פסח (יום ראשון)' },
  { date: '2025-04-14', name: 'פסח (חול המועד)' },
  { date: '2025-04-15', name: 'פסח (חול המועד)' },
  { date: '2025-04-16', name: 'פסח (חול המועד)' },
  { date: '2025-04-17', name: 'פסח (חול המועד)' },
  { date: '2025-04-18', name: 'פסח (חול המועד)' },
  { date: '2025-04-19', name: 'פסח (יום שביעי)' },
  { date: '2025-06-02', name: 'שבועות' },
  { date: '2025-09-23', name: 'ראש השנה (יום ראשון)' },
  { date: '2025-09-24', name: 'ראש השנה (יום שני)' },
  { date: '2025-10-02', name: 'יום כיפור' },
  { date: '2025-10-07', name: 'סוכות (יום ראשון)' },
  { date: '2025-10-08', name: 'סוכות (חול המועד)' },
  { date: '2025-10-09', name: 'סוכות (חול המועד)' },
  { date: '2025-10-10', name: 'סוכות (חול המועד)' },
  { date: '2025-10-11', name: 'סוכות (חול המועד)' },
  { date: '2025-10-12', name: 'סוכות (חול המועד)' },
  { date: '2025-10-13', name: 'הושנא רבה' },
  { date: '2025-10-14', name: 'שמחת תורה' },
  { date: '2025-12-15', name: 'חנוכה' },
  { date: '2025-12-16', name: 'חנוכה' },
  { date: '2025-12-17', name: 'חנוכה' },
  { date: '2025-12-18', name: 'חנוכה' },
  { date: '2025-12-19', name: 'חנוכה' },
  { date: '2025-12-20', name: 'חנוכה' },
  { date: '2025-12-21', name: 'חנוכה' },
  { date: '2025-12-22', name: 'חנוכה' },
  // 2026
  { date: '2026-04-02', name: 'פסח (יום ראשון)' },
  { date: '2026-04-03', name: 'פסח (חול המועד)' },
  { date: '2026-04-04', name: 'פסח (חול המועד)' },
  { date: '2026-04-05', name: 'פסח (חול המועד)' },
  { date: '2026-04-06', name: 'פסח (חול המועד)' },
  { date: '2026-04-07', name: 'פסח (חול המועד)' },
  { date: '2026-04-08', name: 'פסח (יום שביעי)' },
  { date: '2026-05-14', name: 'לג בעומר' },
  { date: '2026-05-22', name: 'שבועות' },
  { date: '2026-09-12', name: 'ראש השנה (יום ראשון)' },
  { date: '2026-09-13', name: 'ראש השנה (יום שני)' },
  { date: '2026-09-21', name: 'יום כיפור' },
  { date: '2026-09-26', name: 'סוכות (יום ראשון)' },
  { date: '2026-09-27', name: 'סוכות (חול המועד)' },
  { date: '2026-09-28', name: 'סוכות (חול המועד)' },
  { date: '2026-09-29', name: 'סוכות (חול המועד)' },
  { date: '2026-09-30', name: 'סוכות (חול המועד)' },
  { date: '2026-10-01', name: 'סוכות (חול המועד)' },
  { date: '2026-10-02', name: 'הושנא רבה' },
