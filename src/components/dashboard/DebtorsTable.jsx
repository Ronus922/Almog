          ...
          <Table className="border-separate border-spacing-0">
            <TableHeader>
              <TableRow className="bg-slate-50/90 border-b border-slate-200/80">
                ...
                <TableHead className="text-center font-bold text-slate-700 text-base py-4 px-6" style={{ width: '120px' }}>פעולות</TableHead>
              </TableRow>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              <svg viewBox="0 0 24 24" className="w-[20px] h-[20px]" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
